...
## **Project Overview**
This project involves creating a containerized API management system to query sports data. It utilizes **Amazon ECS (Fargate)** for container orchestration, **Amazon API Gateway** for REST API endpoints, and an external **Sports API** for accessing real-time sports data. The project highlights advanced cloud computing techniques, including API management, container orchestration, and secure AWS integrations.

---

## **Features**
- Provides a REST API for accessing real-time sports data.
- Utilizes Amazon ECS with Fargate to run containerized backend services.
...
2. **Sports API Key**: Obtain an API key from a sports data provider (e.g., SportsData.io).
...
cd 30-DAY-DEVOPS-CHALLENGE/Day4
```
### **Create ECR Repo**
```bash
